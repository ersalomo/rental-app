   @extends('landing-page.landing-page', ['title' => 'Pricing'])
   @section('content')
                           ...
                           <table class="table">
                               ...
                               <tbody>
                                   ...
                                   <tr class="">
                                       <td class="car-image">
                                           <div class="img"
                                               style="background-image:url(/landing-page/images/car-2.jpg);"></div>
                                       </td>
                                       <td class="product-name">
                                           <h3>Cheverolet SUV Car</h3>
                                           <p class="mb-0 rated">
                                   ...
                                   <tr class="">
                                       <td class="car-image">
                                           <div class="img"
                                               style="background-image:url(/landing-page/images/car-3.jpg);"></div>
                                       </td>
                                       <td class="product-name">
                                           <h3>Cheverolet SUV Car</h3>
                                           <p class="mb-0 rated">
                                   ...
                                   <tr class="">
                                       <td class="car-image">
                                           <div class="img"
                                               style="background-image:url(/landing-page/images/car-4.jpg);"></div>
                                       </td>
                                       <td class="product-name">
                                           <h3>Cheverolet SUV Car</h3>
                                           <p class="mb-0 rated">
                                   ...
                                   <tr class="">
                                       <td class="car-image">
                                           <div class="img"
                                               style="background-image:url(/landing-page/images/car-5.jpg);"></div>
                                       </td>
                                       <td class="product-name">
                                           <h3>Cheverolet SUV Car</h3>
                                           <p class="mb-0 rated">
                                   ...
                                   <tr class="">
                                       <td class="car-image">
                                           <div class="img"
                                               style="background-image:url(/landing-page/images/car-6.jpg);"></div>
                                       </td>
                                       <td class="product-name">
                                           <h3>Cheverolet SUV Car</h3>
                                           <p class="mb-0 rated">
